...
#connection = Connection('paxton-shard-00-00-iyob3.mongodb.net', 27017)
		    ...
		    #mqtt_client.publish("paxton10/location/" + uuid)
		        ...
		        #print "\tAdstring=", Adstring
 		        ...
 		        #db.getSiblingDB("test").getCollection("foo").insert( { "msg" : "My First Document" } )
                        post_id = collection.instert_one(Adstring).inserted_id
 		        #mongorestore --host Paxton-shard-0/paxton-shard-00-00-iyob3.mongodb.net:27017,paxton-shard-00-01-iyob3.mongodb.net:27017,paxton-shard-00-02-iyob3.mongodb.net:27017 --ssl --username crashblandicoot --password <Fiquthyfaz9!> --authenticationDatabase admin 
 		    else:
                        print "****\n"
                done = True
